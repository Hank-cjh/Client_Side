...
BEGIN_MESSAGE_MAP(CClient_SideApp, CWinApp)
...
CClient_SideApp::CClient_SideApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CClient_SideApp 对象

CClient_SideApp theApp;


// CClient_SideApp 初始化

BOOL CClient_SideApp::InitInstance()
{
